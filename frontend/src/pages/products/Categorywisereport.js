...
function Categorywisereportall() {
  ...
  // Export Excel
  const fileName = 'Category Wise Report';
  ...
  const handleprint = useReactToPrint({
    ...
    documentTitle: 'ARANYA HERBALS | CATEGORY WISE REPORT',
    pageStyle: 'print'
  });
  ...
  const downloadPdf = () => {
    ...
    doc.save('Category Wise Report.pdf')
  }
  ...
  return (
    <Box >
      <Headtitle title={'Category Wise Product Report'} />
      { /* ****** Header Content ****** */}
      <Typography variant='body2' sx={userStyle.HeaderText}>Category Wise Product Report</Typography>
      ...
      <Box>
        ...
        <Box sx={{ width: '100%', overflowX: 'hidden' }}>
          <Box component="main" sx={{ paddingRight: '60px', paddingLeft: '60px', paddingTop: '20px', '@media (maxWidth: 600px)': { paddingLeft: '30px', paddingRight: '30px' } }}>
            <Categorywisereportall /><br /><br /><br />
            <Footer /><br />
          </Box>
        </Box>
      </Box>
