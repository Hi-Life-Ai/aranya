...
// const MinimalInvoiceComponent = React.forwardRef((props, ref) => {
//     const { data, heading } = props; // Destructure data and heading from props

//     return (
//         <div ref={ref}>
//             <h2>{heading} Copy</h2> {/* Display the heading */}
//             <Table>
//                 <TableHead>
//                     <TableRow>
//                         <TableCell>Product Name</TableCell>
//                         <TableCell>HSN</TableCell>
//                         {/* Include other header cells */}
//                     </TableRow>
//                 </TableHead>
//                 <TableBody>
//                     {data.invoiceTableData.map((item, index) => (
//                         <TableRow key={index}>
//                             <TableCell>{item.productname}</TableCell>
//                             <TableCell>{item.hsn}</TableCell>
//                             {/* Include other cell data */}
//                         </TableRow>
//                     ))}
//                 </TableBody>
//             </Table>
...
// export default MinimalInvoiceComponent;
...
const InvoiceComponent = ({ data, title, tableData, copyType, pageData }) => {
