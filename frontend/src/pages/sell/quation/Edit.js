...
const Quotationedit = () => {
    ...
    const handleClickOpenpay = () => {
        {
            if (locationData.includes(quotationEdit.referenceno)) {
    ...
    //fetch draft
    const fetchQuotationSingle = async () => {
        try {
    ...
    useEffect(() => {
        setQuotationEdit({ ...quotationEdit, grandtotal: (totalNetCostCalcSub()) })
    ...
    const updateRequest = async () => {
        ...
        try {
            let PRODUCT_REQ = await axios.post(SERVICE.POS_CREATE, {
                ...
                company: String(quotationEdit.company),
                companyaddress: String(quotationEdit.companyaddress == undefined || null ? "" : quotationEdit.companyaddress),
                gstn: String(quotationEdit.gstno),
                bankname: String(quotationEdit.bankname),
                accountnumber: String(quotationEdit.accountnumber),
                ifsccode: String(quotationEdit.ifsccode),
    ...
    const handlePosSubmit = (e) => {
        ...
        setQuotationEdit({ ...quotationEdit, referenceno: newvalpos })
    ...
    const updateQuotation = async () => {
        ...
        try {
            let draftreq = await axios.put(`${SERVICE.QUOTATION_SINGLE}/${id}`, {
                headers: {
                    'Authorization': `Bearer ${auth.APIToken}`
                },
                assignbusinessid: String(quotationEdit.assignbusinessid),
                referenceno: String(quotationEdit.referenceno),
                company: String(quotationEdit.company),
                companyaddress: String(quotationEdit.companyaddress == undefined || null ? "" : quotationEdit.companyaddress),
                gstn: String(quotationEdit.gstno),
                bankname: String(quotationEdit.bankname),
    ...
    return (
        ...
        >
            <Headtitle title={'Quotation Edit'} />
            <form >
                {/* Navbar Start */}
                            ...
                            <Grid sx={{ display: "flex" }}>
                                ...
                                <FormControl size="small" fullWidth>
                                    <Selects
                                        ...
                                        options={company}
                                        placeholder="Company"
                                        value={{ value: quotationEdit.company, label: quotationEdit.company }}
                                        onChange={(e) => {
                                            setQuotationEdit({ ...quotationEdit, company: e.companyname, companyaddress: e.companyaddress, gstno: e.gstno, bankname: e.bankname, accountnumber: e.accountnumber, ifsccode: e.ifsccode });
                                        }}
                                    />
                                </FormControl>
                            </Grid>
                            ...
                            <FormControl>
                                <LocalizationProvider dateAdapter={AdapterDayjs} >
                                    <DateTimePicker
                                        ...
                                        value={quotationEdit.date}
                                        onChange={(newValue) => {
                                            setQuotationEdit({ ...quotationEdit, date: newValue });
                                        }}
                                    />
                                    ...
                                    <FormControl size="small" fullWidth>
                                        <Selects
                                            ...
                                            onChange={(e) => {
                                                fetchDataProd(e);
                                                totalQuantityCalc();
                                                setQuotationEdit({ ...quotationEdit, grandtotal: Number(totalNetCostCalcSub()) })
                                                totalNetRate();
                ...
                <Grid container sx={userStyle.btnGrid}>
                    <Grid item md={8} sm={8} xs={12} sx={{ display: "flex", color: 'black' }}>
                        ...
                        <Typography value={quotationEdit.totalbillamt}
                        ...
                        <Grid container>
                            <Grid item md={6} sm={6} xs={6} sx={{ textAlign: 'left', }}>
                                ...
                                <Grid container>
                                    ...
                                    <Grid item md={6} sm={6} xs={6}>
                                        <Typography>{quotationEdit.bankname}</Typography>
                                        <Typography>{quotationEdit.accountnumber}</Typography>
                                        <Typography>{quotationEdit.ifsccode}</Typography>
                                    </Grid>
                                </Grid>
                            </Grid>
                            <Grid item md={6} sm={6} xs={6} sx={{ textAlign: 'right' }}>
